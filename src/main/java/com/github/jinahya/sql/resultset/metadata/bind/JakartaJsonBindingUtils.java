...
public final class JakartaJsonBindingUtils {
     ...
     * despite their private fields and package-private setters.
     *
     * @apiNote This type is {@code public} so a Jakarta JSON Binding provider can instantiate it reflectively
     *         from the {@code @JsonbVisibility} annotation. Application code normally does not need to reference this
     *         type directly.
     */
